...
function dazzling_scripts() {
  ...
  if( ( is_home() || is_front_page() ) && of_get_option('dazzling_slider_checkbox') == 1 ) {
	...
	wp_enqueue_script( 'dazzling-bootstrapwp', get_template_directory_uri() . '/inc/js/functions.min.js', array('jquery') );

	wp_enqueue_script( 'dazzling-skip-link-focus-fix', get_template_directory_uri() . '/inc/js/skip-link-focus-fix.js', array(), '20140222', true );
